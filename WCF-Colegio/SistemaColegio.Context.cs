...
public partial class BDCOLEGIOEntities : DbContext
{
    ...
    public virtual int usp_RegistrarCurso(string descripcion)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_RegistrarCurso", descripcionParameter);
    }
